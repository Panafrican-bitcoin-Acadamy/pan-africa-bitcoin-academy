-- ============================================================================
-- COMPLETE MIGRATION: Reorder Chapters 12-15
-- ============================================================================
-- This script updates ALL database records to reflect the new chapter order:
-- OLD ORDER:
...
-- ============================================================================
-- STEP 1: Update chapter_progress table
-- ============================================================================
...
-- ============================================================================
-- STEP 2: Update assignments table
-- ============================================================================
...
WHERE title = 'Explorer Scavenger Hunt' 
   OR (chapter_number = 13 AND chapter_slug = 'verify-for-yourself-block-explorers-nodes');
...
-- ============================================================================
-- STEP 3: Create/Update Explorer Scavenger Hunt Assignment (Chapter 12)
-- ============================================================================
-- This ensures the Explorer Scavenger Hunt assignment exists and is linked to Chapter 12
...
-- Note: This will only insert if no assignment with this title exists
...
SELECT 
  ...
  NULL
WHERE NOT EXISTS (
  SELECT 1 FROM assignments WHERE title = 'Explorer Scavenger Hunt'
);

-- ============================================================================
-- VERIFICATION: Check that all updates were applied correctly
-- ============================================================================
