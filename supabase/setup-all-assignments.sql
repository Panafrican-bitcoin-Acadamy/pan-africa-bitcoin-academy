...
-- Chapter 12: Verify for Yourself — Block Explorers & Nodes (Explorer Scavenger Hunt)
INSERT INTO assignments (
  id, title, description, chapter_number, chapter_slug, question, search_address,
  correct_answer, answer_type, points, reward_sats, status, cohort_id, created_at, updated_at
) VALUES (
  ...
  12, 'verify-for-yourself-block-explorers-nodes',
...
INSERT INTO assignments (
  ...
  17, 'multi-sig-collaborative-custody',
