...
export function BlockchainBasicsHeroQuote() {
  return (
    <section
      className="relative overflow-hidden rounded-2xl border border-purple-400/40 bg-zinc-950/95 px-5 py-8 sm:px-10 sm:py-11"
      style={{
        boxShadow:
    ...
    >
      <div
        className="pointer-events-none absolute -left-28 top-1/2 h-72 w-72 -translate-y-1/2 rounded-full bg-purple-500/20 blur-3xl bc-quote-glow-a"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute -right-24 top-0 h-56 w-56 rounded-full bg-cyan-400/18 blur-3xl bc-quote-glow-b"
        aria-hidden
      />
      ...
      <div className="relative z-[1] mx-auto max-w-3xl text-center">
        <span
          className="pointer-events-none absolute left-1 top-0 font-serif text-6xl leading-none text-purple-400/75 sm:left-3 sm:text-8xl bc-quote-mark-left"
          aria-hidden
        >
          &ldquo;
        </span>
        <span
          className="pointer-events-none absolute bottom-0 right-1 font-serif text-6xl leading-none text-cyan-400/70 sm:right-3 sm:text-8xl bc-quote-mark-right"
          aria-hidden
        >
          &rdquo;
        </span>
