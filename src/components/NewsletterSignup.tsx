  ...
  return (
    <section className="w-full border-t border-cyan-400/10 bg-gradient-to-b from-black/60 to-black/90">
      <div className="mx-auto max-w-3xl px-5 py-14 sm:px-8 sm:py-20 text-center">
        {/* Icon */}
        <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500/15 to-cyan-500/15 ring-1 ring-cyan-500/20">
        ...
        {status === 'success' ? (
          <div className="mt-8 inline-flex items-center gap-2 rounded-full bg-green-500/10 px-6 py-3 ring-1 ring-green-500/25">
