  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-4">
        ...
        {/* Hero Content - Positioned on the right, especially on desktop */}
        <div className="relative z-10 ml-auto mr-4 max-w-4xl space-y-8 pr-2 text-center sm:mr-8 sm:pr-4 lg:mr-16 lg:pr-6 xl:mr-24 xl:pr-8 2xl:mr-32 2xl:pr-12 lg:text-right">
          ...
          <p className="mx-auto max-w-2xl text-base text-zinc-400 sm:text-lg lg:ml-auto lg:mr-0">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row lg:items-end lg:justify-end">
            <Link
              href="/apply"
